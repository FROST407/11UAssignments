  ...
  extends JComponent
{
  ...
  public void preSetup()
  {
    ...
    RainAlpha[3] = new Rectangle(250, 450, 5, 5);
    RainAlpha[4] = new Rectangle(3, 426, 5, 5);
    RainAlpha[5] = new Rectangle(60, 460, 5, 5);
    RainAlpha[6] = new Rectangle(20, 5802, 5, 5);
    RainAlpha[7] = new Rectangle(700, 5805, 5, 5);
    RainAlpha[8] = new Rectangle(600, 5860, 5, 5);
    RainAlpha[9] = new Rectangle(745, 5810, 5, 5);
  }
  ...
  public void run()
  {
    ...
    while (!done)
    {
      ...
      RainAlpha[6].y += RainAlpha0YD * RainSpeeed3;
      RainAlpha[7].y += RainAlpha0YD * RainSpeeed3;
      RainAlpha[8].y += RainAlpha0YD * RainSpeeed3;
      ...
      if ((!Menu) && (
        (player.x > 800) || (player.x < 0) || (player.y > 600) || (player.y < 0) || (player.intersects(redBrick)))) {
        player.x = 120;
        player.y = 120;
      }
